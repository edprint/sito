...
export function initBlobField(opts: BlobFieldOptions): void {
  const canvas = document.querySelector<HTMLCanvasElement>(opts.canvas);
  const media = document.querySelector<HTMLElement>(opts.media);
